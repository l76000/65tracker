...
public final class a {
    @q0
    public static Drawable a(@q0 Drawable drawable, @q0 Drawable drawable2) {
        int i10;
        int i11;
        if (drawable == null) {
            return drawable2;
    ...
    @q0
    public static Drawable b(@q0 Drawable drawable, @q0 ColorStateList colorStateList, @q0 PorterDuff.Mode mode) {
        if (drawable == null) {
            return null;
        }
    ...
    @q0
    public static Drawable c(@q0 Drawable drawable, @q0 ColorStateList colorStateList, @q0 PorterDuff.Mode mode) {
        if (drawable == null) {
            return null;
        }
        if (colorStateList == null) {
    ...
    @o0
    public static int[] d(@o0 int[] iArr) {
    ...
    @o0
    public static int[] e(@o0 int[] iArr) {
    ...
    public static android.util.AttributeSet f(@e.o0 android.content.Context r3, @e.m1 int r4, @e.o0 java.lang.CharSequence r5) {
        /*
        ...
        L_0x004a:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: a5.a.f(android.content.Context, int, java.lang.CharSequence):android.util.AttributeSet");
    }

    public static void g(@o0 Outline outline, @o0 Path path) {
    ...
    @TargetApi(21)
    public static void h(@q0 RippleDrawable rippleDrawable, int i10) {
        rippleDrawable.setRadius(i10);
    }

    public static void i(@o0 Drawable drawable, @l int i10) {
        boolean z9;
        if (i10 != 0) {
            z9 = true;
        } else {
        ...
        if (z9) {
            ...
            c.o(drawable, (ColorStateList) null);
        }
    }

    @q0
    public static PorterDuffColorFilter j(@o0 Drawable drawable, @q0 ColorStateList colorStateList, @q0 PorterDuff.Mode mode) {
